      ...
      await txn.update(
        ...
        if (index != -1) {
          ...
          if (oldExp.category == exp.category) {
            ...
            updateCategory(exp.category, newCategory.entries,
                newCategory.totalAmount + diff);
          } else {
            updateCategory(oldExp.category, oldCategory.entries - 1,
                oldCategory.totalAmount - oldExp.amount);
            updateCategory(exp.category, newCategory.entries + 1,
                newCategory.totalAmount + exp.amount);
          }
        }
      });
    });
